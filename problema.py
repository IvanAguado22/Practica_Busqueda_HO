    ...
    def AstarSearch(initialState):
        ...
        while openList!=[] or success == False:
            ...
            if currentState.isGoalState:
                ...
                for s in successors:
                    if !openList.__contains__(s) and !closedList.__contains__(s):
                        openList.append(s)
...
class main():
    ...
    sat1=  Satelite(1, 0, 0, 1, 1, 1, 1, 1, 1) #number, hour, rowA, rowB,  obsCost, turnCost, transferCost, unitCharge, totalBatt
    sat2=  Satelite(2, 0, 2, 3, 1, 1, 1, 1, 8) #number, hour, rowA, rowB,  obsCost, turnCost, transferCost, unitCharge, totalBatt
